...
// Passport configuration - passport.use(), serializeUser, deserializeUser are configuration
// steps and must be called before any requests are handled, i.e. before app.use(passport.initialize())
...
// Server start - app.listen at the bottom so DB connects before server starts
app.listen(8080, () => {
